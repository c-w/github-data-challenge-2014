...
#
# Usage:
#   $ ./crawler.sh 338 10  # fetches 10 batches of results starting at page 338
#   $ ./crawler.sh 338     # fetches 1 batch of results starting at page 338
#   $ ./crawler.sh         # fetches 1 batch of results starting at page 0
